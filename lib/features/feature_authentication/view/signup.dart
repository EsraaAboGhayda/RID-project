...
import 'package:ride_project/core/resources/string.dart';
import 'package:ride_project/core/widgets/app_Button.dart';
import 'package:ride_project/features/feature_authentication/view/createpassword.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void login() {
    setState(() {
      showErrorName = userNameController.text.isEmpty;
      showErrorPhone = phoneNumberController.text.isEmpty;
      showErrorLastname = lastNameController.text.isEmpty;
      showErrorfirstname = fitrstNameController.text.isEmpty;
      showErrorbirthdate = birthDate == null;
    });
                    ...
                    child: IntlPhoneField(
                      ...
                      onChanged: (phone) {
                        ...
                        if (completeNumber.length == 10) {
                          phoneNumberController.text = completeNumber;
                          setState(() {
                            showErrorPhone = false;
                          });
                        } else {
                      ...
                      validator: (phone) {
                        String completeNumber = phone?.completeNumber
                            ...
                            '';
                        if (completeNumber.length != 10) {
                          return 'Please enter a valid phone number with exactly 10 digits';
                        }
                        return null;
                      },
                    ),
